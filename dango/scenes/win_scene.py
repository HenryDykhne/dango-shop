...
class QuotaSucceedScene:
    ...
    def draw(self, screen):
        # title
        title = self.font_title.render("Day Over. You meet the quota!", True, (200, 200, 200))
        screen.blit(title, (SCREEN_W // 2 - title.get_width() // 2, 110))
        result = self.font_title.render(f"¥{self.score}/¥{self.quota}", True, (200, 200, 200))
        ...
        # subtitle
        sub = self.font_sub.render("Grandpa is proud.", True, (200, 200, 200))
